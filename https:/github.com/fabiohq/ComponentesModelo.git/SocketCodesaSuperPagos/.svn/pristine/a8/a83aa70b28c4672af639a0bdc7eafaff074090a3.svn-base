 ...
 * 
 */
public class CmndOperadorExterno990 extends AbstractProcesoVentaRecargas {

	private static final long serialVersionUID = 1L;
	
	public CmndOperadorExterno990(){
		configConex = new ConfigConexionTrama(Constantes.VALOR_N);
	}
	
	@Override
	public String getIdTrama() {
		return Constantes.TRAMA_ID_NORMAL_RECARGA;
	}

	@Override
	public String getNombreAction() throws Exception {
		return CmndOperadorExterno990.class.getCanonicalName();
	}
